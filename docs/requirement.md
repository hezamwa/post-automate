...
- Uploading the hero image to X or LinkedIn — the social post is text; the link (X reply, LinkedIn last line) carries the article (OD-27).
...
| FR-18.2 | Once an article is **live**, each channel that was ticked at the derivatives gate, produced, and connected MUST be posted as the approved channel text **only**. The link to the live article MUST then follow as a **reply to the post on X**; on **LinkedIn it is the post's last line**, in the same post. *(Revised 2026-09-24: LinkedIn refuses comments without its partner-only Community Management API — OD-27.)* | MUST |
